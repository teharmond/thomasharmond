        ...
        <div>
          <div className="border border-gray-300 rounded m-4">
            ...
            <div className="flex flex-col p-4">
              ...
              <p className="pt-3">
                ...
                non-factor. Therefore, I have written the following in a letter
                I’ve sent out to correct this:
              </p>
              <p className="m-2 p-2 text-sm bg-accent rounded">
                ...
                me your faith apart from works, and I by my works will show you
                faith. You believe that God is one; you do well. Even the demons
                believe—and shudder. Do you want to be shown, you senseless
                person, that faith apart from works is worthless? Was not our
                ancestor Abraham justified by works when he offered his son
                Isaac on the altar? You see that faith was active along with his
                works, and by works faith was brought to completion. Thus the
                scripture was fulfilled that says, “Abraham believed God, and it
                was reckoned to him as righteousness,” and he was called the
                friend of God. You see that a person is justified by works and
                not by faith alone. Likewise, was not Rahab the prostitute also
                justified by works when she welcomed the messengers and sent
                them out by another road? For just as the body without the
                spirit is dead, so faith without works is also dead.
                <br />
                <br />
                <span className="font-semibold">James 2:14-26</span> (NRSVue)
              </p>
              <p className="pt-3">Please let me know what your thoughts are.</p>
          ...
          <div className="border border-gray-300 rounded m-4">
            ...
            <div className="flex overflow-scroll p-4 flex-col">
              ...
              <p className="pt-3">
                I think there is a misunderstanding here. People have taken what
                I wrote and have run with it. They have created the doctrine of
                “sola fide,” but that’s not what I wrote about. In fact, your
                letter is the only place in the New Testament where the words
                “faith alone” are used!{" "}
              </p>
              <p className="pt-3">
              ...
              <p className="pt-3">
                ...
                leaves their old life behind, and lives rightly. I thought I was
                quite clear with this in writings such as Romans 6:4, 16; 1
                Corinthians 6:9-11; and Ephesians 5:3-5.
              </p>
              <p className="pt-3">
                I would love to hear how you’re defining faith and works in your
                writing.
              </p>
              ...
              <p className="pt-8 text-xs text-gray-500">
                ...
                (London: Society for Promoting Christian Knowledge, 2019), 745.
                <br />
                2. George Eldon Ladd,{" "}
                <span className="italic">
                ...
                , Rev. ed, 185 (Grand Rapid, MI: W. B. Eerdmans Pub. Co, 2008),
                111.
                <br />
                4. Dunn, <span className="italic">New Perspective on Paul</span>
                , 418; Douglas J. Moo,{" "}
                <span className="italic">
                ...
                Press, 2015), 61; William Varner, “Does James Have a Theology?,”
                Dialogismos 2 (2017): 8-9.
              </p>
            </div>
          </div>
          <div className="border border-gray-300 rounded m-4">
            ...
            <div className="flex flex-col p-4">
              ...
              <p className="pt-3">
                When I’m speaking of faith in this context, I’m speaking more in
                line with the rabbinic definition. I agree that true faith is
                about commitment to God and Christ, and I would agree that
                faith, as you state it, is given to us (see Jas. 1:17-18). I
                just do not want people to misunderstand your gospel as lawless.
                Right living must flow from faith or there is no true faith
                present at all. You too place a high value on this, I know. We
                really are going for the same thing here: we want people to both
                believe and live rightly. I spent some time this week and
                counted 16 times in your letters where you use the phrase “good
                works” in a positive light. Two other things stood out to me as
                I read. First, you commend the Thessalonians for their works of
                faith (1 Thess. 1:3). Second, you told the Galatians that “the
                only thing that counts is faith working through love” (Gal.
                5:6). To which I say, “Exactly.”
              </p>
              <p className="pt-3">
                ...
                on his initial step of faith than on his on-going faithfulness.
                Thoughts?
              </p>
              <p className="pt-3 font-bold">- James</p>
              <p className="pt-8 text-xs text-gray-500">
                ...
                Colossians 1:10; 2 Thessalonians 2:17; 1 Timothy 2:10; 5:10, 25;
                6:18; 2 Timothy 2:21; 3:17; Titus 1:16; 2:7; 3:1, 8, 14.
                <br />
                9. Dunn,
                ...
                (Grand Rapids: Zondervan, 2013), 538; Varner, “Does James Have a
                Theology?”, 9.
              </p>
            </div>
          </div>
          <div className="border border-gray-300 rounded m-4">
            ...
            <div className="flex overflow-scroll p-4 flex-col">
              ...
              <p className="pt-3">
                I will add that I do think that we can’t under-emphasis the fact
                that faith does play a major role in salvation, and this is
                different than traditional Jewish thought. Again, faith should
                lead to action and it isn’t faith without it, but faith does
                save.
              </p>
          ...
          <div className="border border-gray-300 rounded m-4">
            ...
            <div className="flex flex-col p-4">
              ...
              <p className="pt-3">Praying for you and all that you’re doing</p>
