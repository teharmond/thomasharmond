    ...
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-center">
          Word Counter & Sentence Analyzer
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <Collapsible open={isOpen} onOpenChange={setIsOpen}>
          ...
          <CollapsibleContent>
            <div className="mt-4 bg-white p-4 rounded-md border border-gray-200 max-h-[300px] overflow-y-auto">
              {highlightedText}
            </div>
            <div className="flex flex-wrap gap-2 text-sm mt-2">
              ...
              <span className="bg-purple-200 px-2 py-1 rounded">4-8 words</span>
              <span className="bg-green-200 px-2 py-1 rounded">9-14 words</span>
